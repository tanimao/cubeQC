...
void macro_correlation4(){



TString dumpdate      = "0401";
TString histdate      = "0410";
TString readroot  = "_2.root";
TString selectroot= "_1holecor.root";
  ...
  tree->GetEntry( ientry );
    ...
    for (int inum=0; inum<n ; inum++){
       ...
       yholepol[11][1] =     0.994211 ; 
        ...
        hxholeMeancor3->Fill(hid_xholecor3[ientry/6][ientry%6]->GetMean());
        hyholeMeancor3->Fill(hid_yholecor3[ientry/6][ientry%6]->GetMean());
