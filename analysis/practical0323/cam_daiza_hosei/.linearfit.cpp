...
for ( int ientry2 = 0; ientry2 < nentries; ientry2++ )
{
  tree->GetEntry( ientry2 );
        ...
        h_xhole[2]->Fill(xhole[0]/hx1Mean, xhole[2]/hx1Mean);
        h_xhole[3]->Fill(xhole[0]/hx1Mean, xhole[3]/hx1Mean);
        h_xhole[4]->Fill(xhole[0]/hx1Mean, xhole[4]/hx2Mean);
        h_xhole[5]->Fill(xhole[0]/hx1Mean, xhole[5]/hx2Mean);
        h_xhole[6]->Fill(xhole[0]/hx1Mean, xhole[6]/hx2Mean);
        h_xhole[7]->Fill(xhole[0]/hx1Mean, xhole[7]/hx2Mean);
        h_xhole[8]->Fill(xhole[0]/hx1Mean, xhole[8]/hx3Mean);
        h_xhole[9]->Fill(xhole[0]/hx1Mean, xhole[9]/hx3Mean);
        h_xhole[10]->Fill(xhole[0]/hx1Mean, xhole[10]/hx3Mean);
        h_xhole[11]->Fill(xhole[0]/hx1Mean, xhole[11]/hx3Mean);

        h_yhole[0]->Fill(yhole[0]/hy1Mean, yhole[0]/hy1Mean);
        h_yhole[1]->Fill(yhole[0]/hy1Mean, yhole[1]/hy1Mean);
        h_yhole[2]->Fill(yhole[0]/hy1Mean, yhole[2]/hy1Mean);
        h_yhole[3]->Fill(yhole[0]/hy1Mean, yhole[3]/hy1Mean);
        h_yhole[4]->Fill(yhole[0]/hy1Mean, yhole[4]/hy2Mean);
        h_yhole[5]->Fill(yhole[0]/hy1Mean, yhole[5]/hy2Mean);
        h_yhole[6]->Fill(yhole[0]/hy1Mean, yhole[6]/hy2Mean);
        h_yhole[7]->Fill(yhole[0]/hy1Mean, yhole[7]/hy2Mean);
        h_yhole[8]->Fill(yhole[0]/hy1Mean, yhole[8]/hy3Mean);
        h_yhole[9]->Fill(yhole[0]/hy1Mean, yhole[9]/hy3Mean);
        h_yhole[10]->Fill(yhole[0]/hy1Mean, yhole[10]/hy3Mean);
        h_yhole[11]->Fill(yhole[0]/hy1Mean, yhole[11]/hy3Mean);
...
for (int i16=0; i16<16; i16++){
    for (int i6=0; i6<6; i6++){
        ...
        hid_xholecamcor[i16][i6]= new TH1D(id_xholecamcor[i16][i6],"xholecamcor",100,0.25,0.35);
        id_yholecamcor[i16][i6] = "hid_yholecamcor_"+std::to_string(i16)+std::to_string(i6);
        hid_yholecamcor[i16][i6]= new TH1D(id_yholecamcor[i16][i6],"yholecamcor",100,0.25,0.35);
    }
}
// n = 12。
