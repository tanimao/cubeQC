...
TString filedate = "0829yhole2cor";
TString dumpdate = "0829yhole2cor";
...
tree->Branch("xhole",  xhole,  "xhole[1]/D");
tree->Branch("yhole",  yhole,  "yhole[1]/D");
tree->Branch("radius", radius, "radius[1]/D");
tree->Branch("Esum",   Esum,   "Esum[1]/D");
tree->Branch("bump",   bump,   "bump[1]/D");
tree->Branch("xsize",  xsize,  "xsize[1]/D");
tree->Branch("ysize",  ysize,  "ysize[1]/D");
tree->Branch("icam",   icam,   "icam[1]/I");
tree->Branch("direction",direction,"direction[1]/I");

for(Int_t i=0; i<n_cube;i++){
    for(Int_t j=0; j<n; j++){
        fin >>  icam[j] >> direction[j] 
            >> xhole[j] >> yhole[j]
            >> radius[j] >> Esum[j] 
