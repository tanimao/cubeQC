...
TFile *fin     = new TFile("0829goodsizecor.root", "read");
TFile *finbad  = new TFile("0828bad0831cor.root","read");
TTree *tree    = (TTree*)fin->Get("tree");
TTree *treebad = (TTree*)finbad->Get("tree");

//TH1D* h1 = new TH1D("h1","radius",100,40,60); 
//TH1D* h2 = new TH1D("h2","xhole_max",100,150,220); 
//TH1D* h3 = new TH1D("h3","yhole_max",100,150,220); 
...
TH1D* h1full = new TH1D("h1full","radius",100,40,60); 
TH1D* h2full = new TH1D("h2full","xhole_max",100,150,220); 
TH1D* h3full = new TH1D("h3full","yhole_max",100,150,220); 
TH1D* h4full = new TH1D("h4full","xsize_max",100,600,700); 
TH1D* h5full = new TH1D("h5full","ysize_max",100,600,700); 
...
TH1D* h1b = new TH1D("h1b","radius",100,40,60); 
TH1D* h2b = new TH1D("h2b","xhole_max",100,150,220); 
TH1D* h3b = new TH1D("h3b","yhole_max",100,150,220); 
TH1D* h4b = new TH1D("h4b","xsize_max",100,600,700); 
TH1D* h5b = new TH1D("h5b","ysize_max",100,600,700); 
...
for ( int ientry = 0; ientry < nentries; ientry++ )
{
    ...
    //if ()  
//   47 < radius[0] && radius[0] < 53 &&
//   47 < radius[1] && radius[1] < 53 &&
//   47 < radius[2] && radius[2] < 53 &&
//   47 < radius[3] && radius[3] < 53 &&
//   47 < radius[4] && radius[4] < 53 &&
//   47 < radius[5] && radius[5] < 53 &&
 //
// 176-1 < xhole[0] && xhole[0] < 202+1 &&
// 176-1 < xhole[1] && xhole[1] < 202+1 &&
// 176-1 < xhole[2] && xhole[2] < 202+1 &&
// 176-1 < xhole[3] && xhole[3] < 202+1 &&
// 176-1 < xhole[4] && xhole[4] < 202+1 &&
// 176-1 < xhole[5] && xhole[5] < 202+1 )//&&
//  
// 176-1 < yhole[0] && yhole[0] < 202+1 &&
// 176-1 < yhole[1] && yhole[1] < 202+1 &&
// 176-1 < yhole[2] && yhole[2] < 202+1 &&
// 176-1 < yhole[3] && yhole[3] < 202+1 &&
// 176-1 < yhole[4] && yhole[4] < 202+1 &&
// 176-1 < yhole[5] && yhole[5] < 202+1 )//&&
 //  
//  642 < xsize[0] && xsize[0] < 674 &&
//  642 < xsize[1] && xsize[1] < 674 &&
//  642 < xsize[2] && xsize[2] < 674 &&
//  642 < xsize[3] && xsize[3] < 674 &&
//  642 < xsize[4] && xsize[4] < 674 &&
//  642 < xsize[5] && xsize[5] < 674 &&
//  
//  642 < ysize[0] && ysize[0] < 676 &&
//  642 < ysize[1] && ysize[1] < 676 &&
//  642 < ysize[2] && ysize[2] < 676 &&
//  642 < ysize[3] && ysize[3] < 676 &&
//  642 < ysize[4] && ysize[4] < 676 &&
//  642 < ysize[5] && ysize[5] < 676 &&
// //
// Esum[0] < 200 &&
// Esum[1] < 200 &&
// Esum[2] < 200 &&
...
TFile *fout = new TFile("0829goodsizecormax.root", "recreate");
//h1->Write();
//h2->Write();
//h3->Write();
//h4->Write();
