            ...
            for i in range(3):
                ...
                for j in range(4):
                 ...
                 #   saveName  = 'cube13cam1_22' 
                    ...
                    ImageName = 'mao_pictures/pic0415/'+ saveName + '.jpg' 
...
###############deeplearning用の画像生成########## サイズを 660*60　に固定
                    ...
                    cv2.imwrite('edge/'+ saveName +  'left.jpg',eleft)
                    cv2.imwrite('edge/'+ saveName+   'top.jpg',etop)
                    cv2.imwrite('edge/'+ saveName+ 'right.jpg',eright)
                    cv2.imwrite('edge/'+ saveName+'bottom.jpg',ebottom)
...
##############################
            ...
            #バンプ検出、どう扱うか。       
                    ...
                    file = open('files/data0421test.txt','a')
