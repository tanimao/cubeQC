...
#    print("PRESS 1 to ROTATE and WRITE PICTURE")
    ...
    picfolder = 'mao_pictures/pic201225/'
    ...
    if key == ord('1') : 
        ...
        #time.sleep(2)    
        #print('cam1,2,3:')
        cv2.imwrite(picfolder+'cube{0}cam1.jpg'.format(cubeID), img_cam1)
        #print('mao_pictures/pic0731est/cube{0}cam1.jpg'.format(cubeID))
        cv2.imwrite(picfolder+'cube{0}cam2.jpg'.format(cubeID), img_cam2)
        #print('mao_pictures/pic0731test/cube{0}cam2.jpg'.format(cubeID))
        cv2.imwrite(picfolder+'cube{0}cam3.jpg'.format(cubeID), img_cam3)
        #print('mao_pictures/pic0731test/cube{0}cam3.jpg'.format(cubeID))
   

#        flag=0
        cubeID_saveNames = [cubeID, 'cube'+str(cubeID)+'cam1', 'cube'+str(cubeID)+'cam2', 'cube'+str(cubeID)+'cam3']#, flag]
...
#    print("PRESS 1 to ROTATE and WRITE PICTURE")
    ...
    if key == ord('1') : 
        ...
        #time.sleep(2)    
        #print('cam1,2,3:')
        cv2.imwrite(picfolder +'cube{0}cam1.jpg'.format(cubeID), img_cam1)#####cam1~3については、新しいキューブ
        ...
        #'''
        cv2.imwrite(picfolder+'cube{0}cam4.jpg'.format(cubeID-1), img_cam4)#####cam4~6については、さっき1~3を撮影した
        #print('mao_pictures/pic0609test/cube{0}cam1.jpg'.format(cubeID-1))                #####前のキューブだから、cubeIDは1減らして使う
        cv2.imwrite(picfolder+'cube{0}cam5.jpg'.format(cubeID-1), img_cam5)
        #print('mao_pictures/pic0731test/cube{0}cam2.jpg'.format(cubeID-1))
        cv2.imwrite(picfolder+'cube{0}cam6.jpg'.format(cubeID-1), img_cam6)
        #print('mao_pictures/pic0731test/cube{0}cam3.jpg'.format(cubeID-1))
        #'''

#        flag=0
        cubeID_save6Names = [cubeID, 'cube'+str(cubeID) + 'cam1', 'cube'+str(cubeID) + 'cam2', 'cube'+str(cubeID) + 'cam3',
                                    'cube'+str(cubeID-1)+'cam4', 'cube'+str(cubeID-1)+'cam5', 'cube'+str(cubeID-1)+'cam6']#, flag]

        ###camera456についてはcubeID-1 としているから、cubeIDというのは常にcamera123のキューブのこと。
