...
### こいつらがあるものだと思って一旦書く。
    ...
    if gapymin > delta :  ###輪郭の方が直線より外にある時。
        ...
        whiteymin = round(len(Sgy1[Sgy1 > 40]), 4)  ### 白ピクセルの絶対数（各辺について求める）
        ### この時点で細かい小数点以下は切っておく
    ...
    if gapymax > delta :
        ...
        whiteymax = round(len(Sgy2[Sgy2 > 40]), 4)
    ...
    if gapxmin > delta :
        ...
        whitexmin = round(len(Sgx3[Sgx3 > 40]), 4)
    ...
    if gapxmax > delta :
        ...
        whitexmax = round(len(Sgx4[Sgx4 > 40]), 4)
