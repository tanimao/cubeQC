...
def detect_HoughCircles(saveName,img,img2, col):
    ...
    '''
    circles = cv2.HoughCircles(edges, cv2.HOUGH_GRADIENT, 1, 20, param1=20,param2=18,minRadius=5,maxRadius=23)
...
def main():
        ...
        for j in range(5):
            ...
            saveName  = 'bad2_500mm'+str(j+2) 
            ImageName = 'mao_pictures/test0930/'+ saveName + '.jpg' 
    ...
    #        cube_size = detect_Outline_wColFigure(result2, 1, 500)
            ...
            file = open('files/cube_distance2_0930.txt', 'a')
