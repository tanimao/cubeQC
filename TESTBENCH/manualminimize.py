...
def gradient_descent(f, initial_position, const, learning_rate=0.05, steps=100):
    """勾配法で最小値を求める関数
    ...
    # 現在地を示すカーソル
    x = initial_position
    print('Esum[first]={}'.format( f(x, const[0], const[1], const[2], const[3])))
...
#    Esum, initial = output
    ...
    min_pos = gradient_descent(f,initial, const)
