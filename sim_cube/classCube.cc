...

{
    ...
    if (d[1] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[1]/2-par2[4])>fabs(hole[1]-(par2[3]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par2[1];
        }
    ...
    if (d[2] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[2]/2-par3[4])>fabs(hole[2]-(par3[3]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par3[1];
        }
    ...
    if (d[3] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[3]/2-par4[4])>fabs(hole[3]-(par4[3]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par4[1];
        }
    ...
    if (d[4] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[4]/2-par5[4])>fabs(hole[4]-(par5[3]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par5[1];
        }
    ...
    if (d[5] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[5]/2-par6[4])>fabs(hole[5]-(par6[3]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par6[1];
        }
    ...
    if (d[6] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[6]/2-par7[4])>fabs(hole[6]-(par7[3]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par7[1];
        }
    ...
    if (d[7] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[7]/2-par8[4])>fabs(hole[7]-(par8[3]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par8[1];
        }
...

{
    ...
    if (d[1] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[1]/2-par2[4])>fabs(hole[1]-(par2[2]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par2[1];
        }
    ...
    if (d[2] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[2]/2-par3[4])>fabs(hole[2]-(par3[2]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par3[1];
        }
    ...
    if (d[3] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[3]/2-par4[4])>fabs(hole[3]-(par4[2]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par4[1];
        }
    ...
    if (d[4] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[4]/2-par5[4])>fabs(hole[4]-(par5[2]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par5[1];
        }
    ...
    if (d[5] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[5]/2-par6[4])>fabs(hole[5]-(par6[2]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par6[1];
        }
    ...
    if (d[6] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[6]/2-par7[4])>fabs(hole[6]-(par7[2]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par7[1];
        }
    ...
    if (d[7] >= 1){  // かさ上げ必要なし。
        ...
        if (fabs(fibarea[7]/2-par8[4])>fabs(hole[7]-(par8[2]+sizemax[1]))){
            //hole[1]はそのまま
            //fibarea[1]もそのまま
            sizemax[1] =sizemax[1] + par8[1];
        }
